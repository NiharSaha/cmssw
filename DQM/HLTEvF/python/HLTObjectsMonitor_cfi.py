...
#    debug = cms.untracked.bool(True),
    ...
    caloJetBTags      = cms.untracked.InputTag("hltCombinedSecondaryVertexBJetTagsCalo"),
    pfJetBTags        = cms.untracked.InputTag("hltCombinedSecondaryVertexBJetTagsPF"),
    muCandidates      = cms.untracked.InputTag("hltL3NoFiltersNoVtxMuonCandidates"),
    eleCandidates     = cms.untracked.InputTag("hltEgammaCandidates"),
...
#    debug = cms.untracked.bool(True),
    ...
    pfJetBTags        = cms.untracked.InputTag("hltCombinedSecondaryVertexBJetTagsPF"),
    muCandidates      = cms.untracked.InputTag("hltL3NoFiltersNoVtxMuonCandidates"),
    eleCandidates     = cms.untracked.InputTag("hltDoubleEle8CaloIdMGsfTrackIdMDphiFilter"),
    processName    = cms.string("HLT"),
    plots = cms.VPSet(
    )
)
...
#    debug = cms.untracked.bool(True),
    ...
    pfJetBTags        = cms.untracked.InputTag("hltCombinedSecondaryVertexBJetTagsPF"),
    muCandidates      = cms.untracked.InputTag("hltL3NoFiltersNoVtxMuonCandidates"),
    eleCandidates     = cms.untracked.InputTag("hltEgammaHollowTrackIso"),
    processName    = cms.string("HLT"),
    plots = cms.VPSet(
    )
)
...
#    debug = cms.untracked.bool(True),
    ...
    caloJetBTags      = cms.untracked.InputTag("hltCombinedSecondaryVertexBJetTagsCalo"),
    pfJetBTags        = cms.untracked.InputTag("hltCombinedSecondaryVertexBJetTagsPF"),
    muCandidates      = cms.untracked.InputTag("hltGlbTrkMuonCandsNoVtx"),
    eleCandidates     = cms.untracked.InputTag(""),
    processName    = cms.string("HLT"),
    plots = cms.VPSet(
    )
)
